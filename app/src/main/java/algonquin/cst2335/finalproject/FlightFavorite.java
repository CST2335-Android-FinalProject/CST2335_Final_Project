...
import algonquin.cst2335.finalproject.databinding.ActivityFlightFavoriteBinding;

public class FlightFavorite extends AppCompatActivity {

    ActivityFlightFavoriteBinding binding;
    ArrayList<FlightResult> flightResults;
    RecyclerView.Adapter<FlightFavorite.MyRowHolder> myAdapter;
    FlightDatabase myDB ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityFlightFavoriteBinding.inflate(getLayoutInflater());
...
//                flightModel.selectedFlight.postValue(selected);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder( FlightFavorite.this );
